...
void wifi_app_scene_spam_ssids_menu_on_enter(void* context) {
    ...
    submenu_add_item(
        app->submenu, "Funny SSIDs", SpamSsidsIndexFunny,
        spam_ssids_callback, app);
    submenu_add_item(
        app->submenu, "Rick Roll", SpamSsidsIndexRickroll,
        spam_ssids_callback, app);
    submenu_add_item(
        app->submenu, "Random SSIDs", SpamSsidsIndexRandom,
        spam_ssids_callback, app);
    submenu_add_item(
        app->submenu, "Custom SSIDs", SpamSsidsIndexCustom,
        spam_ssids_callback, app);
